...
/**
 *This class draws circular image with shaded circle around it.
 * Created by sivanagakishore on 23/5/16.
 */
...
//        setBorderWidth(30);
//        setBorderColor(getResources().getColor(R.color.colorlightGrey50));
//        shadowRadius = DEFAULT_SHADOW_RADIUS;
//        drawShadow(shadowRadius, Color.BLACK);
    ...
    private void drawShadow(float shadowRadius, int shadowColor) {
        ...
        paintBorder.setShadowLayer(shadowRadius, 20f, shadowRadius / 2, shadowColor);
    }
